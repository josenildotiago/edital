...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'auto' => [
            'unique' => 'Já existe uma defesa em nosso sistema pra esse auto de infração',
            'required' => 'Obrigatório informar o nº do auto de infração'
        ],
        'tipo' => [
            'required' => 'Obrigatório informar o tipo de formulário'
        ]
    ],
